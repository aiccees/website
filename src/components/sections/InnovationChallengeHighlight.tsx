...
import { focusAreas, innovationChallengeLink } from '@/components/data_models/innovation-challenge'
    ...
    <AOS>
      <section id="innovation-challenge" className="w-full py-16 md:py-24 bg-gradient-to-b from-white to-green-50">
        <div className="container w-11/12 mx-auto px-4 md:px-6">
          ...
          <div className="mt-14 rounded-2xl bg-green-700 px-6 py-8 md:px-10 md:py-10 text-white flex flex-col lg:flex-row gap-5 lg:items-center lg:justify-between">
            <div>
              <h3 className="text-2xl font-bold">Applications are open across Africa</h3>
              <p className="mt-2 text-green-50 max-w-2xl">
