...
export default function Exhibitions() {
  ...
  const packages = [
    {
      name: "Basic Booth",
      price: "₦250,000 or $188",
      features: [
        "Booth Carcass",
        "Complimentary Plastic Table and Chair"
      ],
      popular: false,
      applicationLink: "https://forms.cloud.microsoft/r/7DfVXNFnN4?origin=lprLink"
    },
    {
      name: "Standard Booth",
      price: "₦460,000 or $345",
      features: [
        "Booth Carcass",
        "2 Seats",
        "1 Counter Table",
        "Branding and Magazine Rack"
      ],
      popular: true,
      applicationLink: "https://forms.cloud.microsoft/r/27i72JrvTD?origin=lprLink"
    }, 
    {
      name: "Premium Booth",
      price: "₦540,000 or $405",
      features: [
        "Booth Carcass", 
        "4 Seats", 
        "1 Counter Table", 
      ...
      popular: false,
      applicationLink: "https://forms.cloud.microsoft/r/2ZwdzXiJTg?origin=lprLink"
    }
  ]
